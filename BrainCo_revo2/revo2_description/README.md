...
The thumb has 3 actuated joints (abduction + 2 flexion); each of the four fingers has
2 actuated joints. The distal joints are coupled to the proximal ones via `<mimic>`.

### Left Hand Joints

| Joint Name | Description | Range (degrees) | Range (radians) |
|------------|-------------|-----------------|-----------------|
| left_thumb_metacarpal_joint | Thumb abduction | 0 ~ 89 | 0 ~ 1.55334 |
| left_thumb_proximal_joint | Thumb flexion (MCP) | 0 ~ 60 | 0 ~ 1.04720 |
| left_thumb_distal_joint | Thumb flexion (PIP), mimic 1.0945x | 0 ~ 66 | 0 ~ 1.15192 |
| left_index_proximal_joint | Index MCP | 0 ~ 80.79 | 0 ~ 1.41 |
| left_index_distal_joint | Index PIP, mimic 1.131x | 0 ~ 97 | 0 ~ 1.69297 |
| left_middle_proximal_joint | Middle MCP | 0 ~ 80.79 | 0 ~ 1.41 |
| left_middle_distal_joint | Middle PIP, mimic 1.267x | 0 ~ 97 | 0 ~ 1.69297 |
| left_ring_proximal_joint | Ring MCP | 0 ~ 80.79 | 0 ~ 1.41 |
| left_ring_distal_joint | Ring PIP, mimic 1.252x | 0 ~ 97 | 0 ~ 1.69297 |
| left_pinky_proximal_joint | Pinky MCP | 0 ~ 80.79 | 0 ~ 1.41 |
| left_pinky_distal_joint | Pinky PIP, mimic 1.271x | 0 ~ 97 | 0 ~ 1.69297 |

### Right Hand Joints

| Joint Name | Description | Range (degrees) | Range (radians) |
|------------|-------------|-----------------|-----------------|
| right_thumb_metacarpal_joint | Thumb abduction | 0 ~ 89 | 0 ~ 1.55334 |
| right_thumb_proximal_joint | Thumb flexion (MCP) | 0 ~ 60 | 0 ~ 1.04720 |
| right_thumb_distal_joint | Thumb flexion (PIP), mimic 1.0945x | 0 ~ 66 | 0 ~ 1.15192 |
| right_index_proximal_joint | Index MCP | 0 ~ 80.79 | 0 ~ 1.41 |
| right_index_distal_joint | Index PIP, mimic 1.131x | 0 ~ 97 | 0 ~ 1.69297 |
| right_middle_proximal_joint | Middle MCP | 0 ~ 80.79 | 0 ~ 1.41 |
| right_middle_distal_joint | Middle PIP, mimic 1.267x | 0 ~ 97 | 0 ~ 1.69297 |
| right_ring_proximal_joint | Ring MCP | 0 ~ 80.79 | 0 ~ 1.41 |
| right_ring_distal_joint | Ring PIP, mimic 1.252x | 0 ~ 97 | 0 ~ 1.69297 |
| right_pinky_proximal_joint | Pinky MCP | 0 ~ 80.79 | 0 ~ 1.41 |
| right_pinky_distal_joint | Pinky PIP, mimic 1.271x | 0 ~ 97 | 0 ~ 1.69297 |
