...
│   ├── revo2_left_hand.urdf.xacro    #左手xacro宏（可在整机URDF中include）
│   ├── revo2_right_hand.urdf     #右手URDF描述文件
│   └── revo2_right_hand.urdf.xacro   #右手xacro宏（可在整机URDF中include）
├── rviz/                         #RViz2配置文件
...
拇指 3 个主动关节（外展 + 2 个屈伸），其余四指每指 2 个主动关节；
末节关节通过 `<mimic>` 与近节耦合联动。

### 左手关节

| 关节名称 | 描述 | 角度范围（度） | 角度范围（弧度） |
|------------|-------------|-----------------|-----------------|
| left_thumb_metacarpal_joint | 拇指外展 | 0 ~ 89 | 0 ~ 1.55334 |
| left_thumb_proximal_joint | 拇指屈伸（MCP） | 0 ~ 60 | 0 ~ 1.04720 |
| left_thumb_distal_joint | 拇指屈伸（PIP），mimic 1.0945x | 0 ~ 66 | 0 ~ 1.15192 |
| left_index_proximal_joint | 食指 MCP | 0 ~ 80.79 | 0 ~ 1.41 |
| left_index_distal_joint | 食指 PIP，mimic 1.131x | 0 ~ 97 | 0 ~ 1.69297 |
| left_middle_proximal_joint | 中指 MCP | 0 ~ 80.79 | 0 ~ 1.41 |
| left_middle_distal_joint | 中指 PIP，mimic 1.267x | 0 ~ 97 | 0 ~ 1.69297 |
| left_ring_proximal_joint | 无名指 MCP | 0 ~ 80.79 | 0 ~ 1.41 |
| left_ring_distal_joint | 无名指 PIP，mimic 1.252x | 0 ~ 97 | 0 ~ 1.69297 |
| left_pinky_proximal_joint | 小指 MCP | 0 ~ 80.79 | 0 ~ 1.41 |
| left_pinky_distal_joint | 小指 PIP，mimic 1.271x | 0 ~ 97 | 0 ~ 1.69297 |

### 右手关节

| 关节名称 | 描述 | 角度范围（度） | 角度范围（弧度） |
|------------|-------------|-----------------|-----------------|
| right_thumb_metacarpal_joint | 拇指外展 | 0 ~ 89 | 0 ~ 1.55334 |
| right_thumb_proximal_joint | 拇指屈伸（MCP） | 0 ~ 60 | 0 ~ 1.04720 |
| right_thumb_distal_joint | 拇指屈伸（PIP），mimic 1.0945x | 0 ~ 66 | 0 ~ 1.15192 |
| right_index_proximal_joint | 食指 MCP | 0 ~ 80.79 | 0 ~ 1.41 |
| right_index_distal_joint | 食指 PIP，mimic 1.131x | 0 ~ 97 | 0 ~ 1.69297 |
| right_middle_proximal_joint | 中指 MCP | 0 ~ 80.79 | 0 ~ 1.41 |
| right_middle_distal_joint | 中指 PIP，mimic 1.267x | 0 ~ 97 | 0 ~ 1.69297 |
| right_ring_proximal_joint | 无名指 MCP | 0 ~ 80.79 | 0 ~ 1.41 |
| right_ring_distal_joint | 无名指 PIP，mimic 1.252x | 0 ~ 97 | 0 ~ 1.69297 |
| right_pinky_proximal_joint | 小指 MCP | 0 ~ 80.79 | 0 ~ 1.41 |
| right_pinky_distal_joint | 小指 PIP，mimic 1.271x | 0 ~ 97 | 0 ~ 1.69297 |
