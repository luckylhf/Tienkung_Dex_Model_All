...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="输出文件夹；默认：mujoco/meshes_convex",
    )
    args = parser.parse_args()

    # 默认路径
    in_dir = args.input if args.input is not None else package_dir / "meshes"
    out_dir = args.output if args.output is not None else package_dir / "mujoco" / "meshes_convex"
